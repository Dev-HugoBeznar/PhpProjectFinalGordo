...
<div class="containerColumnCenter" style="padding: 50px;">
    ...
    <div class="containerRow" style="align-items: end;">
        <form action="../../clases/insertDB.php?id_viaje=<?php echo $id_viaje; ?>" method="post"
            ...
            <textarea class="formTextFormat" name="descripcion"
                required><?php echo trim($descripcion); ?></textarea><br>
            ...
            <input type="date" class="formTextFormat" name="fecha_fin" value="<?php echo trim($fechaFin); ?>"
                required><br>
            ...
            <input type="text" class="formTextFormat" name="tipo_de_viaje" value="<?php echo trim($tipo); ?>"
                required><br>
        ...
        <img src="<?php echo $src; ?>" style=" height: 50%; max-width: 400px; padding: 10px; border-radius: 15px;">
    </div>
</div>
